...
XLS_PATH = "labelled_imageCSV.xlsx"
IMAGE_DIR = "manually_labelled"
IMAGE_SIZE = 224

CHECKPOINTS = {
    "VGG19": "checkpoints_40epochs/vgg19_augmented.pth",
    "ViT": "checkpoints_40epochs//vit_best_.pth",
    "MLP_Mixer": "checkpoints_40epochs//mlp_best.pth",
}

# EXACT manual label names (must match Excel)
CLASS_NAMES = [
    "Big mammals",
    "Birds",
    "Opossum",
...
for model_name, checkpoint_path in CHECKPOINTS.items():
    ...
    output_csv = f"test_inference{model_name}.csv"
